...
enum Defaults {
    static let settings = Settings(
        ...
        switching: .init(automatic: true, bypassOption: false, cmdCtrlWhitelist: []),
        retro: .init(enabled: true),
        rules: .init(minWordLength: 3, ignoreUrlsEmails: true),
        apps: .init(blacklist: [], whitelist: []),
        layouts: .init(active: [], languageMap: [:], pair: .init(fromID: "com.apple.keylayout.US", toID: "com.apple.keylayout.Russian")),
